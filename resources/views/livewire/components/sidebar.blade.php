        ...
        <div class="sidebar">
            ...
            <nav class="mt-3 pb-3 mb-b">
               ...
               with font-awesome or any other icon font library -->
                    <li class="nav-item">
                        <a href="#" wire:click="redirectDashboard" class="nav-link {{ request()->routeIs('adminlte.dashboard') ? 'active' : '' }}">
                    ...
                    @can('suppliers_access')
                        <li class="nav-item">
                            <a href="#" wire:click="redirectSuppliers" class="nav-link {{ request()->routeIs('suppliers.*') ? 'active' : '' }}">
