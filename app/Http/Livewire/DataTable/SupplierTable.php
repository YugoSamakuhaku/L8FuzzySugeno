...
final class SupplierTable extends PowerGridComponent
{
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('id_supplier_formatted', fn (Supplier $model) => 'S-' . '' . str_pad('' . $model->id_supplier, 5, '0', STR_PAD_LEFT))
    ...
    */
    ...
    {
        return [
            Column::make('ID SUPPLIER', 'id_supplier_formatted'),
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', 'Edit')
                ...
                ->route('suppliers.edit', ['supplier' => 'id_supplier'])
